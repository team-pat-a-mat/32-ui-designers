...
import LoaderComponent from "@/app/components/loader/loader_component";
  ...
  return (
    <div className="max-w-md mx-auto bg-black text-white">
      <header className="flex justify-between items-center px-4 py-3">
        <h2 className="text-2xl">더보기</h2>
        <div className="flex items-center p-3 justify-center space-x-3">
          <svg
      ...
      {click ? (
        <div className="grid grid-cols-4 grid-rows-4">
          <div className="text-center p-3 text-xs flex flex-col space-y-1">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 24 24"
